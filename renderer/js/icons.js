...
const paths = {
  ...
  files: '<path d="M20 7h-3a2 2 0 0 1-2-2V2"/><path d="M9 18a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h7l5 5v11a2 2 0 0 1-2 2Z"/><path d="M3 7.6v12.8A2 2 0 0 0 5 22h9"/><path d="M15 2v5h5"/>',
  shrink: '<path d="m15 15 6 6"/><path d="m15 9 6-6"/><path d="M21 16v5h-5"/><path d="M21 8V3h-5"/><path d="M3 16v5h5"/><path d="m3 21 6-6"/><path d="M3 8V3h5"/><path d="M9 9 3 3"/>',
  ...
  layers: '<path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83Z"/><path d="m22 12.65-8.58 3.91a2 2 0 0 1-1.66 0L3.2 12.65"/><path d="m22 17.65-8.58 3.91a2 2 0 0 1-1.66 0L3.2 17.65"/>',
  ...
  panelLeftClose: '<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 3v18"/><path d="m14 9 3 3-3 3"/>',
...
export function svgIcon(name, size = 20) {
  const body = paths[name] || paths.fileText;
...
export function mountIcons(root = document) {
  root.querySelectorAll("[data-icon]").forEach((el) => {
    ...
    el.innerHTML = svgIcon(name, parseInt(size, 10));
  });
}
